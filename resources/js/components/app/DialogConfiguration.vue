<template>
  ...
  >
    <v-card>
      <v-window v-model="onboarding">
        <v-window-item key="card-0">
          <v-card
            ...
            height="500"
          >
            <div class="card-0-image" />
            <v-btn
              color="secondary"
              class="card-0-btn-mobile d-lg-none"
            ...
            <v-btn
              color="secondary"
              class="card-0-btn d-none d-lg-block"
              outlined
              @click="changeLanguage"
            >
              <v-icon left>
            ...
            <div class="d-flex card-0-text align-center justify-center">
              <div class="text-center d-lg-none">
                <h1 class="text-h5">
                  {{ $vuetify.lang.t('$vuetify.onboarding.welcome') }}
                </h1>
                <h2 class="text-subtitle-1">
                  {{ $vuetify.lang.t('$vuetify.onboarding.headline') }}
                </h2>
              </div>
        ...
        <v-window-item key="card-1">
          <v-card
            color="transparent"
            height="500"
            class="pa-6 overflow-y-auto d-flex flex-column"
          >
            <div class="text-center mb-4">
              <h1 class="text-h5 mb-2">
                {{ $vuetify.lang.t('$vuetify.onboarding.conditionsTitle') }}
              </h1>
              <h2 class="title">
                {{ $vuetify.lang.t('$vuetify.onboarding.conditionsHeadline') }}
              </h2>
            </div>
            <p
              class="text-body-1"
              v-html="$vuetify.lang.t('$vuetify.onboarding.conditionsBody')"
            />
            <div class="flex-grow-1" />
            <p
              class="text-body-1"
              v-html="$vuetify.lang.t('$vuetify.onboarding.contributions')"
            />
          </v-card>
        </v-window-item>
        <v-window-item key="card-2">
          ...
          >
            <div class="text-center mb-4">
              <h1 class="text-h5 mb-2">
                {{ $vuetify.lang.t('$vuetify.onboarding.regionTitle') }}
              </h1>
              <h2 class="title">
                {{ $vuetify.lang.t('$vuetify.onboarding.regionHeadline') }}
              </h2>
            </div>
            <v-row>
              <v-col
                v-for="region in loadedRegions"
                :key="region.id"
                cols="12"
                md="6"
              ...
              >
                <div
                  class="region-choice-box"
                  :class="{ 'region-choice-box-active': settingsActiveRegion === region.slug }"
                  @click="settingsActiveRegion = region.slug"
                >
                  <div
                    class="region-choice-map pb-2"
                    v-html="region.map"
                  />
                  <div class="d-flex justify-space-between mx-1">
                    ...
                    <v-icon
                      v-if="settingsActiveRegion === region.slug"
                      class="region-choice-check"
                      color="secondary"
                    >
                      {{ mdiSvg.checkCircle }}
                    </v-icon>
        ...
        <v-window-item key="card-3">
          ...
          >
            <div class="text-center mb-4">
              <h1 class="text-h5 mb-2">
                {{ $vuetify.lang.t('$vuetify.onboarding.agenciesTitle') }}
              </h1>
              <h2 class="title">
                {{ $vuetify.lang.t('$vuetify.onboarding.agenciesHeadline') }}
              </h2>
            </div>
            <v-alert
              :icon="mdiSvg.alert"
        ...
        <v-window-item key="card-4">
          ...
          >
            <div class="text-center mb-4">
              <h1 class="text-h5 mb-2">
                {{ $vuetify.lang.t('$vuetify.onboarding.settingsTitle') }}
              </h1>
              <h2 class="title">
                {{ $vuetify.lang.t('$vuetify.onboarding.settingsHeadline') }}
              </h2>
            </div>
            ...
            <div
              v-if="pwa.showPromotion"
              class="settings-row d-flex pa-2 secondary darken-1"
            >
              <div class="settings-label flex-grow-1">
      ...
      <v-card-actions
        v-else
        class="justify-space-between card-actions"
      >
        <v-btn
          text
          color="primary"
