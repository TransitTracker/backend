export default {
  ...
  download: {
    ...
    agencySelect: 'Agence',
    agencyLicense: 'En continuant, vous acceptez la licence choisie par l\'agence.',
    agencyNotDownloadable: 'La licence de cette agence n\'autorise pas le téléchargement.',
    agencyRead: 'Lire la licence complète',
    formatStep: 'Choisissez le format',
    formatDesc: 'Les deux options sont des fichiers CSV. Ils contiennent une structure similaire, mais ont des ensembles de données différents.',
    formatLoaded: 'Véhicules chargés (que vous pouvez actuellement voir dans l\'application)',
    formatDump: 'Tous les véhicules (enregistrés depuis le début de Transit Tracker - contient des véhicules inactifs)',
    formatNotLoaded: 'Cette agence n\'est pas chargée actuellement. Activez-la dans l\'onglet Paramètres pour choisir l\'option chargée.',
    downloadStep: 'Télécharger',
    downloadBtn: 'Télécharger',
    downloadLoading: 'Préparation du téléchargement ... cela devrait prendre moins d\'une minute.',
    downloadReady: 'Votre fichier est maintenant prêt.',
    downloadError: 'Une erreur s\'est produite lors de la préparation de votre fichier. Veuillez réessayer plus tard.',
    downloadError429: 'Vous avez dépassé le nombre maximum de téléchargements par heure. Veuillez réessayer plus tard.',
  },
  onboarding: {
