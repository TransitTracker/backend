...
@section('body')
    <div class="container grid grid-cols-1 px-4 mx-auto mt-8 md:grid-cols-3 gap-y-8 gap-x-12">
        ...
        <div class="col-span-full">
            <small class="text-xs font-medium tracking-widest uppercase">Buses without labels</small>
            <ul class="mt-1 bg-white shadow">
                ...
                <li>
                    <div class="px-4 py-3">
                        ...
                        <small class="text-sm leading-tight">Last seen on route: {{ $vehicle->trip->route_short_name }}</small>
                    </div>
                </li>
                @endforeach
            </ul>
