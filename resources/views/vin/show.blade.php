...
@section('body')
    <div class="container grid grid-cols-1 px-4 mx-auto mt-8 md:grid-cols-3 gap-y-8 gap-x-12">
        ...
        <div
            class="col-span-full font-medium text-[1.375rem] leading-7 text-m3-primary-on-container dark:text-white -mt-6 md:-mt-10 flex items-center gap-x-2" x-data="{ vinInfo: false }">
                ...
                <form action="" method="POST"
                    ...
                    @error('g-recaptcha-response')
                        <div class="mb-4 text-xs font-medium text-red-500">
                            {{ __('The reCAPTCHA validation has failed. Please try again.') }}</div>
                    @enderror

                    <div class="flex">
                        <button data-sitekey="{{ config('transittracker.recaptcha.site') }}"
