...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="apple-touch-icon" href="/img/ios-icon-512.png">
        <link rel="apple-touch-icon" sizes="120x120" href="/img/ios-icon-120.png">
        <link rel="apple-touch-icon" sizes="152x152" href="/img/ios-icon-152.png">
        <link rel="apple-touch-icon" sizes="167x167" href="/img/ios-icon-167.png">
        <link rel="apple-touch-icon" sizes="180x180" href="/img/ios-icon-180.png">
