...
class VehicleController extends Controller
{
    public function show(string $vin)
    {
        ...
        $vehicles = Vehicle::query()
            ...
            ->exo()
            ->with(['agency:id,slug,short_name,color,text_color', 'gtfsRoute:agency_id,gtfs_route_id,short_name,long_name', 'trip:agency_id,gtfs_trip_id,headsign,short_name', 'tags:id,label,description,color,text_color', 'vinInformationForceRef'])
