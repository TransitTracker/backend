    ...
    <v-row>
      ...
      >
        <v-card>
          ...
          <v-card-text>
            <span v-html="$vuetify.lang.t('$vuetify.settings.agenciesBody')" />
            <v-expansion-panels
              ...
              >
                <v-expansion-panel-header>
                  <div class="d-flex align-center mr-2">
                    ...
                    <v-btn
                      v-if="region.slug !== stateActiveRegion.slug"
                      color="secondary"
                      small
                ...
                <v-expansion-panel-content>
                  ...
                  >
                    ...
                    <v-list-item-avatar :style="{ backgroundColor: agency.color, borderColor: agency.text_color }">
                      <v-icon
            ...
            >
              <v-icon left>
                {{ mdiSvg.check }}
              </v-icon> {{ $vuetify.lang.t('$vuetify.settings.agenciesApply') }}
            </v-btn>
          </v-card-text>
        </v-card>
      </v-col>
      ...
      >
        <v-card>
          ...
          <v-card-text>
            <p class="mb-2">
              {{ $vuetify.lang.t('$vuetify.settings.otherChanges') }}
            </p>
      ...
      >
        <v-card
          ...
          class="about"
        >
          <v-card-title class="wb-bw">
            {{ $vuetify.lang.t('$vuetify.settings.aboutTitle') }}
          </v-card-title>
          <v-card-text>
            <span v-html="$vuetify.lang.t('$vuetify.settings.aboutBody')" /><br>
            <v-btn
              color="secondary"
              class="mt-3 mb-3"
              href="https://github.com/felixinx/transit-tracker"
            >
              <v-icon left>
                {{ mdiSvg.github }}
              </v-icon> {{ $vuetify.lang.t('$vuetify.settings.aboutSource') }}
            </v-btn><br>
            <span v-html="$vuetify.lang.t('$vuetify.settings.aboutContributions')" />
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
