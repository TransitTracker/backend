...
class OperatorController extends Controller
{
    public function show(Tag $tag)
    {
        ...
        $tag->load([
            'exoVinVehicles:id,agency_id,vehicle_id,force_vehicle_id,label,force_label,updated_at,gtfs_route_id,gtfs_trip_id',
        ...
        $agencies = $tag->exoVinVehicles->groupBy('agency')->sortDesc();
