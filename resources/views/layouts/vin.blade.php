...
<body class="relative min-h-screen font-sans bg-primary-100 dark:bg-m3-background-dark">
    <nav class="w-full text-xl bg-m3-primary text-m3-primary-on dark:bg-m3-primary-dark-container dark:text-m3-primary-dark-on-container drop-shadow">
        <div class="container flex items-center justify-between px-4 py-4 mx-auto">
            <a href="{{ route('vin.index') }}"class="flex items-center justify-center text-sm font-medium tracking-wider bg-white bg-opacity-0 rounded h-9 w-9 hover:bg-opacity-10">
    ...
    <footer class="absolute bottom-0 w-full h-12 mt-20 dark:text-white">
        ...
        <div class="container px-4 mx-auto mt-4 text-sm lg:hidden">
            <div class="bg-primary-900 px-1 py-0.5 text-sm rounded text-white font-medium inline-block">{{ __('Cookies') }}</div>
            {{ __('This website uses cookies to show you which suggestions you have made and which suggestions you have approved.') }}
        </div>
    </footer>
