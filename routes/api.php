...
foreach (['api', 'v1'] as $apiGroup) {
    Route::prefix($apiGroup)->group(function () use ($totalAgencies, $totalAgencies3) {
        /*
         * Vehicles
         */
...
//    Route::get('vehicles/{agency}', [\App\Http\Controllers\Api\V2\VehicleController::class, 'index']);
//});